  ...
  const projects = [
    {
      num: "01",
      title: "InterviewPro",
      desc: "A real-time collaborative technical interview platform featuring video calling, live chat, coding challenges, code execution, session management, and automated cleanup workflows.",
      wins: [
        "Built real-time video interviews using Stream Video SDK with participant management",
        "Integrated live chat channels using Stream Chat for interviewer-candidate communication",
        "Designed session lifecycle management with join, end, heartbeat and activity tracking",
        "Automated abandoned session cleanup using Inngest cron jobs and heartbeat monitoring",
        "Secured application with Clerk authentication and protected API routes",
      ],
      tags: [
        "React",
        "Node.js",
      ...
      color: "#0f4c81",
      github: "https://github.com/divyansh369/InterviewPro",
      live: "https://interview-pro-six.vercel.app/",
    },
    {
      num: "02",
      ...
      color: "#1a5c4e",
      github:
        "https://github.com/divyansh369/Automated-Security-Configuration-Auditor",
    },
    {
      num: "03",
      ...
      <div className="wrap projects-wrap">
        ...
        <div className="projects-grid">
          {projects.map((proj, i) => (
            <div
              key={i}
              className={`proj-card ${i === 0 ? "reveal-left" : "reveal-right"}`}
